...
> なお、デモでお試しいただける読取は **入出庫あわせて5件まで**（入庫3件・出庫2件を想定）とさせていただいています。
> 読取のたびにAI（API）の利用料がかかり、個人開発で運用しているためのお願いです。何卒ご理解ください。
> もっと試したい・実際の運用でお使いになりたいという場合は、上記アドレスまでお気軽にご連絡ください。

---

## ライセンス

**All Rights Reserved（著作権全面留保）** — [LICENSE](LICENSE)

本リポジトリは内容の閲覧・技術的な参考のために公開しているものです。
複製・改変・再配布・商用利用は許諾していません。ご利用をご希望の場合は上記のお問い合わせ先までご連絡ください。
