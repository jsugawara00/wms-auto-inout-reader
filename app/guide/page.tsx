...
const WISDOM = [
  {
    icon: "🗓️",
    title: "読み込みを忘れても大丈夫",
    body: "記録は「実際に物が動いた日（出荷日・入荷日）」が基準。翌日に処理しても、昨日の出荷は昨日の記録になります。",
  },
  {
    icon: "🩹",
    title: "月末処理後のプレビュー特化のフィードバック対応",
    body: "月末を確定した後でも、先方との突合で数値の調整が必要になることがあります。確定した原本は変えずに、プレビュー（印刷用の表示）側で調整し、履歴を残せます。",
  },
  {
    icon: "🧾",
    title: "例外の請求も1枚に",
...
export default function GuidePage() {
  return (
    <div className="space-y-10">
      ...
      <section className="space-y-3">
        <div>
          <h2 className="text-lg font-bold">④ 現場の知恵（あると嬉しい機能）</h2>
          <p className="text-sm text-neutral-500">
            倉庫の現場で本当に困る場面を、正面から機能にしています。
          </p>
        </div>
